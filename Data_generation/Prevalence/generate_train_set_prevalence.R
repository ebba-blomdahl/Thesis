...
load("/Users/ebbablomdahl/Thesis/Thesis/datasets/test_set_10000_per_center.RData")
...
generate_train_set <- function(nbr_oncology = 5, nbr_non_oncology = 5, center_size = 500, center_type_predictor = TRUE, prevalence_large = TRUE, prevalence_small = FALSE){
  ...
  print(nbr_non_onco)
  print(center_size)
  print(center_type_predictor)
  print(prevalence_large)
  print(prevalence_small)
  ...
  if(prevalence_small == TRUE){
    ## for training set ##
    # calculate the center-specific prevalence based on small training set
    ...
    ## for test set ##
    # draw 100 random samples from each center and calculate center-specific prevalence 
